...
/// <summary>
/// Validador para objetos de prueba de AutoMapper
/// </summary>
public class TestSourceValidator : AbstractValidator<TestSource>
{
    public TestSourceValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
        ...
        RuleFor(x => x.Price)
            ...
            .WithMessage("El precio no puede exceder $1000");
...
/// </summary>
public abstract class TestSourceValidatorWithBase<T> : AbstractValidator<T> where T : class
{
    /// <summary>
